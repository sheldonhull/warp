...
use crate::ai::conversation_status_ui::{render_status_element, status_tint_color};
...
fn summary_conversation_status_for_terminal(
    ...
    if let Some(session) = cli_agent_session
        ...
        .filter(|s| crate::terminal::cli_agent_sessions::listener::agent_supports_rich_status(&s.agent))
    {
